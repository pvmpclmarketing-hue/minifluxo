...
function lyricCss(text) {
  return `.lyric{box-sizing:border-box;width:100%;height:100%;display:flex;align-content:center;justify-content:flex-start;flex-wrap:wrap;padding:0 42px;text-align:left;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:${fontSize(text)}px;font-weight:800;text-transform:uppercase;line-height:.98;letter-spacing:-1.5px;color:#fff;word-spacing:3px;text-shadow:0 3px 16px rgba(0,0,0,.76);overflow-wrap:normal}.lyric span{display:inline-block;white-space:nowrap}.lyric .entering{color:#6f6870}`;
}
