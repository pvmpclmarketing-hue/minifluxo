...
export async function POST(request) {
  try {
    ...
    const payload={connection_id:connection.id,owner_id:user.id,payment_flow_id:body.payment_flow_id||null,site_flow_id:body.site_flow_id||null,conversation_flow_id:body.conversation_flow_id||null,updated_at:new Date().toISOString()};
