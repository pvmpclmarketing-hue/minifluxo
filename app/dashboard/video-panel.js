...
export default function VideoPanel({ initialVideos = [] }) {
  ...
  async function submit(event) {
    ...
    try {
      ...
      setNotice('Transcrevendo e sincronizando a letra com a música...');
