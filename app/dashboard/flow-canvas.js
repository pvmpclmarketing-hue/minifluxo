...
const blocks = {
  ...
  deliver: { label:'Entrega', icon:'OK', tone:'teal', description:'Envia as 2 musicas em audio', config:{ intro:'Sua musica esta pronta! Vou enviar as duas faixas em audio.', tracks:2 } }
};
